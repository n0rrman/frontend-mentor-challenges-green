  ...
  return (
    <>
      <main className="flex flex-col items-center justify-center text-[1.1275rem] text-center text-grayishBlue space-y-20 py-6 md:py-8">
        ...
        <section className="flex flex-col justify-center items-center z-20 gap-4 py-1.5 px-8 sm:px-0">
          <h1 className="text-[1.7rem] sm:text-[2.175rem] font-semibold text-darkGrayishBlue">
            Keep track of your snippets
          </h1>
          <p className="max-w-[45rem] leading-7 text-[1rem] sm:text-[1.15rem]">
        ...
        <section className="flex flex-col justify-center items-center z-20 gap-4 pt-[3.9rem] px-7 sm:px-0">
          <h1 className="text-[1.7rem] sm:text-[2.175rem] font-semibold text-darkGrayishBlue">
            Access Clipboard anywhere
          </h1>
          <p className="max-w-[45rem] text-[1rem] sm:text-[1.15rem] leading-[1.85rem] mb-[5.25rem]">
        ...
        <section className="flex flex-col justify-center items-center z-20 gap-4 px-7 sm:px-0">
          <h1 className="text-[1.7rem] sm:text-[2.175rem] font-semibold text-darkGrayishBlue -mt-3">
            Supercharge your workflow
          </h1>

          <p className="text-[1rem] sm:text-[1.15rem]">
            We&apos;ve got the tools to boost your productivity.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 items-start gap-6 pt-9 mt-0.5 pb-[8.6rem] px-2 sm:px-[10rem] text-[0.97rem] leading-[1.9rem]">
          ...
          <div className="flex flex-col flex-wrap md:flex-row gap-[4rem] sm:gap-[6rem] justify-center items-center pt-1 pb-[4.6rem] px-4">
        ...
        <section className="flex flex-col justify-center items-center z-20 gap-4 max-w-[45rem] pb-8 px-7 sm:px-0">
          <h1 className="text-[1.7rem] sm:text-[2.2rem] font-semibold text-darkGrayishBlue">
            Clipboard for iOS and Mac OS
          </h1>

          <p className="text-[1rem] sm:text-inherit">
      ...
      <footer className="flex flex-col md:flex-row gap-12 sm:gap-[8.5rem] text-darkGrayishBlue/80 text-[1.1rem] items-center justify-center bg-grayishBlue/10 py-10 px-0 md:px-[10.3rem] mt-12">
        ...
        <div className="flex flex-row justify-center items-center gap-10 sm:gap-6">
